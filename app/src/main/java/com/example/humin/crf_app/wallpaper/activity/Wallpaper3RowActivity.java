...
import com.example.humin.crf_app.wallpaper.fragment.ThreeRowFragment;
import com.example.humin.crf_app.wallpaper.presenter.Wallpaper3RowPresenter;
...
public class Wallpaper3RowActivity extends BaseActivity implements Wallpaper3RowView{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Wallpaper3RowPresenter presenter = new Wallpaper3RowPresenter(service, this);
