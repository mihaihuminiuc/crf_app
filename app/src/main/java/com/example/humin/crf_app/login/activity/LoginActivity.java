package com.example.humin.crf_app.login.activity;
...
import com.example.humin.crf_app.login.fragment.LoginFragment;
import com.example.humin.crf_app.login.presenter.LoginPresenter;
...
public class LoginActivity extends BaseActivity implements LoginView{
    ...
    public void onFailure(String appErrorMessage) {
        mProgressBar.setVisibility(View.GONE);
        Toast.makeText(mContext,"Error:"+appErrorMessage,Toast.LENGTH_LONG).show();
    }
